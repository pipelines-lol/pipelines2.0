...
const Offerings = () => {
  ...
  // Add a field { once: true } to only animate once
  ...
  return (
    <div className="flex h-full w-full flex-col items-center  justify-center border-b-[0.5px] border-t-[0.5px] border-pipeline-blue-200">
